    ...
    return (
        <div className='Miniside-bar' style={{ backgroundColor: Theme.miniSideBar }}>
            ...
            <ul className="Links list-unstyled">
                ...
                <li onClick={Collapse} className="active"><Link className="link" to={'/admain/'}>
                ...
                <li onClick={Collapse}><Link className="link" to={'/admain/add'}>
                    <span className="topPiece"></span>
                    <span className="bottomPiece"></span>  <span className="topPiece"></span>
                    <span className="bottomPiece"></span>
                    <span className="me-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-infinity" viewBox="0 0 16 16">
                        <path d="M5.68 5.792 7.345 7.75 5.681 9.708a2.75 2.75 0 1 1 0-3.916ZM8 6.978 6.416 5.113l-.014-.015a3.75 3.75 0 1 0 0 5.304l.014-.015L8 8.522l1.584 1.865.014.015a3.75 3.75 0 1 0 0-5.304l-.014.015L8 6.978Zm.656.772 1.663-1.958a2.75 2.75 0 1 1 0 3.916L8.656 7.75Z" />
                    </svg></span>Add User</Link></li>


                <li onClick={Collapse}><Link className="link" to={'/admain/allusers'}>
                    <span className="topPiece"></span>
                    <span className="bottomPiece"></span>  <span className="topPiece"></span>
                    <span className="bottomPiece"></span>
                    <span className="me-2">
                        ...
                        </svg></span>All User</Link></li>




                <li onClick={Collapse}><Link className="link" to={'/admain/library'}>
                    <span className="topPiece"></span>
                    <span className="bottomPiece"></span>
                ...
                <li onClick={Collapse}><Link className="link" to={'/admain/classes'}>
                    <span className="topPiece"></span>
                    <span className="bottomPiece"></span>
                ...
                <li onClick={Collapse}><Link className="link" to={'/admain/news'}>
                    <span className="topPiece"></span>
                    <span className="bottomPiece"></span>
                    <span className="me-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-gear-fill" viewBox="0 0 16 16">
                        <path d="M9.405 1.05c-.413-1.4-2.397-1.4-2.81 0l-.1.34a1.464 1.464 0 0 1-2.105.872l-.31-.17c-1.283-.698-2.686.705-1.987 1.987l.169.311c.446.82.023 1.841-.872 2.105l-.34.1c-1.4.413-1.4 2.397 0 2.81l.34.1a1.464 1.464 0 0 1 .872 2.105l-.17.31c-.698 1.283.705 2.686 1.987 1.987l.311-.169a1.464 1.464 0 0 1 2.105.872l.1.34c.413 1.4 2.397 1.4 2.81 0l.1-.34a1.464 1.464 0 0 1 2.105-.872l.31.17c1.283.698 2.686-.705 1.987-1.987l-.169-.311a1.464 1.464 0 0 1 .872-2.105l.34-.1c1.4-.413 1.4-2.397 0-2.81l-.34-.1a1.464 1.464 0 0 1-.872-2.105l.17-.31c.698-1.283-.705-2.686-1.987-1.987l-.311.169a1.464 1.464 0 0 1-2.105-.872l-.1-.34zM8 10.93a2.929 2.929 0 1 1 0-5.86 2.929 2.929 0 0 1 0 5.858z" />
                ...
                <li onClick={Collapse}><Link className="link" to={'/admain/transports'}>
                    <span className="topPiece"></span>
                    <span className="bottomPiece"></span>
